...
import { ClientAuthForm } from "@/components/system/client-auth-form";
import { ClientLoginForm } from "@/components/system/client-login-form";
  ...
  return (
    <>
      <div className="container relative md:min-h-screen h-screen flex flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <Button
          variant="ghost"
          className="absolute right-4 top-24 md:right-8 md:top-8"
          onClick={toggleForm}
        >
          {isNewUser
        ...
        <div className="lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            {isNewUser ? <ClientLoginForm /> : <ClientAuthForm />}
